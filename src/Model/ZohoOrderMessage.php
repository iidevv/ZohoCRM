...
/**
 * @ORM\Entity
 * @ORM\Table(name="zoho_order_messages", indexes={
 *          @ORM\Index (name="id", columns={"id"}),
 *          @ORM\Index(name="zoho_id", columns={"zoho_id"})
 *  }
 * )
 */
class ZohoOrderMessage extends AEntity
{
    /**
     * @var \XC\VendorMessages\Model\Message
     * @ORM\Id
     * @ORM\OneToOne(targetEntity="XC\VendorMessages\Model\Message", cascade={"merge", "detach", "persist"})
