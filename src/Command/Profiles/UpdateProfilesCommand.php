...
namespace Iidev\ZohoCRM\Command\Profiles;
...
class UpdateProfilesCommand extends Command
{
    ...
    protected static $defaultName = 'ZohoCRM:UpdateProfiles';

    protected MessageBusInterface $bus;
    protected UpdateProfilesDispatcher $dispatcher;

    public function __construct(MessageBusInterface $bus, UpdateProfilesDispatcher $dispatcher)
    {
        parent::__construct();
        $this->bus = $bus;
