...
class UpdateProductsCommand extends Command
{
    ...
    protected static $defaultName = 'ZohoCRM:UpdateProducts';

    protected MessageBusInterface    $bus;
    protected UpdateProductsDispatcher $dispatcher;

    public function __construct(MessageBusInterface $bus, UpdateProductsDispatcher $dispatcher)
    {
        parent::__construct();
        $this->bus = $bus;
