...
use Iidev\ZohoCRM\Core\Factory\Commands\PushOrderMessagesCommandFactory;
...
class CreateOrderMessagesDispatcher
{
    ...
    public function __construct()
    {
        ...
        $commandFactory = Container::getContainer() ? Container::getContainer()->get('Iidev\ZohoCRM\Core\Factory\Commands\PushOrderMessagesCommandFactory') : null;
