...
class Profile extends \XLite\View\ItemsList\Model\Profile
{
    public static function getAllowedTargets()
    {
        $list = parent::getAllowedTargets();

        $list[] = Zoho::TAB_PROFILES;
    ...
    protected function defineColumns()
    {
        ...
        foreach ($columns as $columnName => $columnData) {
            if (!in_array($columnName, ['login', 'name'])) {
                continue;
            }
    ...
    protected function removeEntity(\XLite\Model\AEntity $entity)
    {
        ...
        if ($profileId) {
            \XLite\Core\Database::getRepo(\Iidev\ZohoCRM\Model\ZohoProfile::class)
                ->deleteEntities($profileId);
    ...
    protected function getSearchCondition()
    {
        ...
        $result->{\XLite\Model\Repo\Profile::SEARCH_ZOHO_PROFILES} = true;
    ...
    {
        return [
            'data-widget' => 'Iidev\ZohoCRM\View\ItemsList\Model\Profile'
        ];
    }
}